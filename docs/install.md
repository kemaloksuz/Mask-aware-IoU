...
Note: We tested our implementation with Pytorch 1.4, CUDA 10.1 and mmcv 0.6.2 on Linux.
...
```shell
conda create -n Mask-aware-IoU python=3.7 -y
conda activate Mask-aware-IoU
```
